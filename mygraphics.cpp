...
void drawboard(char **arr, int row, int col)
{
	for (int i = 0; i < row; i++)
	{
		for (int j = 0; j < col; j++)
		{
			...
			{
				{
					myRect(i * 15, j * 15, (i * 15) + 15, (j * 15) + 15, RGB(0, 0, 0), RGB(0, 0, 255));
				}
			}
			else if (arr[j][i] == ' ') 
			{
			...
			{
				{
					myRect(i * 15, j * 15, (i * 15) + 15, (j * 15) + 15, RGB(0,0,0), RGB(0,100,255));
				}
			}
			else if (arr[j][i] == 'b')
			{
				{
					myEllipse(i * 15, j * 15, (i * 15) + 15, (j * 15) + 15, RGB(0, 0, 0), RGB(255, 255, 100));
				}
			}
			else  
			{
